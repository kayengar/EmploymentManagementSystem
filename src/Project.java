...
import java.sql.*;
 class ProGUI{
	...
	JFrame jf,jf1,jf2,jf3,jf5,jf6,jf7,jf8,abtus,contact;
	ImagePanel jp,jp1,jp2,jp3,jp4,jp5,jp6,jp7,jp8,jpabt,jpcon;
	JButton jb1,jb2,jb3,jb4,jb7,jb8,jb9;
	JButton jbNex,jbResumes,home1,home2,home3,home5,home6,home7,home8,home9,home10,jbMismatch,jbRet,jbRemJob;
  ...
  JScrollPane jsp10,jspRes,jspJobs;
	...
	jp = new ImagePanel(new ImageIcon("background-16.jpg").getImage());
	jf.add(jp);
	jf.pack();
	...
	ImagePanel jp1 = new ImagePanel(new ImageIcon("aditi.jpg").getImage());
	jf1.add(jp1);
	jf1.pack();
	...
	home1.setBounds(0,50,100,20);
		...
		jl88 = new JLabel("Reach great heights by getting your dream Job from our Database..!");
		jl88.setForeground(Color.white);
		
		jp1.add (jb3);
        jp1.add (jb4);
        jp1.add (jl7);
		jp1.add(jl88);
		jl88.setBounds(0,0,500,20);
	...
	jmb.add(cont);
	ActionListener alAbt = new ActionListener(){
		public void actionPerformed(ActionEvent e){
			if(e.getSource() == abt){
				abtus = new JFrame("About Us");
				abtus.setSize(800,800);
				abtus.setDefaultCloseOperation(abtus.EXIT_ON_CLOSE);
				jpabt = new ImagePanel(new ImageIcon("pro.jpg").getImage());
				abtus.add(jpabt);
				home9 = new JButton("Home");
				jpabt.add(home9);
					ActionListener alHome = new ActionListener(){
						public void actionPerformed(ActionEvent e){
							if(e.getSource() == home9){
							jf.setVisible(true);
							abtus.setVisible(false);
							}
						}
					};
					home9.addActionListener(alHome);
					home9.setBounds(200,50,100,20);
				abtus.setVisible(true);
			}
			else
			  if(e.getSource() == cont){
				contact = new JFrame("Contact Us");
				contact.setSize(800,800);
				contact.setDefaultCloseOperation(abtus.EXIT_ON_CLOSE);
				jpcon = new ImagePanel(new ImageIcon("Contact Page.jpg").getImage());
				contact.add(jpcon);
				home10 = new JButton("Home");
				jpcon.add(home10);
					ActionListener alHome = new ActionListener(){
						public void actionPerformed(ActionEvent e){
							if(e.getSource() == home10){
							jf.setVisible(true);
							contact.setVisible(false);
							}
						}
					};
					home10.addActionListener(alHome);
					home10.setBounds(300,50,100,20);
				contact.setVisible(true);
			}
		}
	   };
	
	abt.addActionListener(alAbt);
	cont.addActionListener(alAbt);
    ...
    jp6.add(jsp10);
	jsp10.setBounds(100,200,500,100);
	...
	//Alignment:
		...
		jl1.setBounds(10, 75, 120, 20);
		t1.setBounds(140, 75, 100, 20); 
		jl2.setBounds(10, 95, 120, 20); 
		t2.setBounds(140, 95, 100, 20); 
...
//		ACTION LISTENER FOR RESUME:
	...
	jf3.add(jp3);
	JLabel jlEmp = new JLabel("Welcome" +t3.getText()+"!!!");
	jlEmp.setFont(new Font("Sans-Serif", Font.BOLD, 14));
	jlEmp.setForeground(Color.white);
	jp3.add(jlEmp);
	jlEmp.setBounds(10,10,100,20);
	...
	home7.setBounds(400,20,100,20);
			...
			jp7.add(jspRes);	
			jspRes.setBounds(50,100,700,200);
	...
	ActionListener alJob = new ActionListener(){
     ...
     String[] jcbposItems = {"Manager", "Salesman", "Receptionist", "Clerk", "President"};
		...
		jbRemJob = new JButton("Remove Job");
		jp8.add(jbRemJob);
    	...
    	jbRemJob.setBounds (50,500,120,25);
    ...
    tableCol133.setHeaderValue("POST");   
		...
		if(e.getSource() == jbRemJob){
				...
				String query2 = "DELETE FROM JOBS WHERE JOBTYPE='"+jcbJT.getSelectedItem().toString()+"' AND COMPANY='"+jcomp5.getText()+"' AND POST='"
								+jcbpos.getSelectedItem().toString()+"'";
				
				 int rs2 = S2.executeUpdate(query2); // Returns 1 on successful INSERT
         if (rs2 == 1)
            JOptionPane.showMessageDialog(null,"JOB VACANCY REMOVED SUCCESFULLY");
         else

		    JOptionPane.showMessageDialog(null,"COULD NOT REMOVE DETAILS. CHECK IF ONE OR MORE INFORMATION IS FILLED WRONGLY");
			...
			jbRemJob.addActionListener(alla);
	...
	//Bounds:
		...
		jp3.setLayout(null);
		jb7.setBounds(10,40,150,35);
		jb8.setBounds(10,80,150,35);
...
class SplashScreen extends JWindow  {
  ...
  public void showSplash() {
    ...
    JLabel copyrt = new JLabel("Copyright 2010-2011, Karthik & Aaditya associates",JLabel.CENTER);
...
INSERT INTO JOBS VALUES('ARUL & CO','ACCOUNTS','MANAGER'),
		...
		ADD CONSTRAINT PK PRIMARY KEY(USERNAME);
